...
Run DA-MCMC for `N=50,000` iterations with (default) prior. The entire latent is updated each iteration.
...
Traceplot for `R_0`. The true value is$R_0=2$ (red dotted line on the figure).
